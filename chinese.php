        ...
        array (
            ...
            'Main Interface' =>
                array (
                    ...
                    'Open with' => '打开方式',
                    'Extract PDF pages' => '提取PDF页面',
                    'Google Docs Viewer' => 'Google Docs阅读器',
                    'Folder Index' => '文件夹索引',
                    'Folder Index: %1' => '文件夹索引: %1',
                    'E-mail Files' => 'E-mail 文件',
                    'Share with users' => '与其他用户共享',
                    'Clear selection' => '清除已选中',
                    'Get link' => '生成Web链接',
                    'Details and activity' => '通知',
                    'Copy direct link' => '复制链接',
                    'Versioning' => '版本',
                    ...
                    'Deleted from' => '从何处删除',
                    'Trash' => '回收站',
                    'Threre are no deleted files' => '回收站为空',
                    'Restore' => '还原',
                    'Recent' => '最近',
                    'Shared by me' => '由我共享',
                    ...
                    'Add Files' => '添加文件',
                    'Add Folder' => '添加目录',
                    'Pause selected' => '暂停已选中',
                    'Remove selected' => '删除已选中',
                    'Pause all' => '暂停所有',
                    'Cancel' => '取消',
                    'Cancel all' => '取消所有',
                    'Skip file' => '跳过文件',
                    'Resume selected' => '恢复已选中',
                    'Resume' => '恢复',
                    'File name' => '文件名',
                    'Uploaded' => '已上传',
                    'Progress' => '进度',
                    ...
                    'Starred' => '已标星',
                    'Remove star' => '取消收藏',
                    'There are no starred files or folders' => '没有已标星的文件或文件夹',
                    ...
                    'Emptying trash...' => '正在清空...',
                    'Empty trash?' => '确定要清空? ',
                    'All files and folders in your trash are about to be permanently deleted.' => '回收站中的所有文件和文件夹将被永久删除',
                    ...
                    'Photos, Documents, Contracts...' => '图片, 文件, 文档...',
                    'Shared with' => '共享',
                    'Search options' => '搜索选项',
                    ...
                    'Show all' => '显示全部',
                    'Documents' => '文件',
                    'Showing only "Photos"' => '当前仅显示 "图片"',
                    'Audio' => '音频',
                    'Showing only "Audio"' => '当前仅显示 "音频"',
                    'Video' => '视频',
                    'Showing only "Video"' => '当前仅显示 "视频"',
                    'Last taken' => '最近拍摄',
                    'By date' => '按 日期 分组',
                    'By tag' => '按 标签 分组',
                    'Music' => '音乐',
                    ...
                    'There are no collections' => '没有收藏夹',
                    'Create a new collection' => '新建收藏夹',
            ...
            'General' =>
                array (
                    ...
                    'One file moved to trash.' => '移动文件到回收站',
                    '%1 files successfully moved to trash.' => '%1 个文件已成功移至回收站',
                    'One folder moved to trash.' => '移动文件夹到回收站',
                    '%1 files and folders successfully deleted.' => '%1 个文件和文件夹已成功删除',
                    '%1 files and folders successfully moved to trash.' => '%1 个文件和文件夹已成功移至回收站',
            ...
            'Web Links' =>
                array (
                    // 'Options' => '选项',
                    'Options' => '选项',
                    'Allow visitors to download this file.' => '允许访客下载此文件',
                    'Receive e-mail notifications.' => '接受电子邮件提示',
                    'Receive e-mail notifications when visitors upload or download files via this link.' => '当访客通过此链接上传或下载文件时接收电子邮件通知',
                    'Share the file comments with the visitors.' => '与访客分享文件的评论',
                    'Share the metadata with the visitors.' => '与访客分享文件的元数据',
                    // 'Restrictions' => '限制',
                    'Restrictions' => '限制',
                    'Expiration date' => '过期时间',
                    'The link will stop working at the end of this specified day.' => '该链接将在此指定日期结束时失效',
                    'Download limit' => '可供下载次数',
                    'Specify a number of downloads after which the link will stop working.' => '该链接将在指定下载次数时失效',
                    'Set a password' => '设置密码',
                    'Require visitors to be signed in.' => '要求访客登录',
                    ...
                    'Allow visitors to upload files.' => '允许访客上传文件',
                    'Upload' => '上传',
            ...
            'Admin: Users' =>
                array (
                    ...
                    'An e-mail message with the login information will be sent to the user\'s address.' => '一封包含登录信息的邮件已经被发送给用户。',
                    'Submit' => '提交',
                    'Cancel' => '取消',
            ...
            'Admin: Setup' =>
                array (
                    ...
                    'Media library features' => '媒体库特性',
                    'Photos' => '图片',
                    'Videos' => '视频',
                    'Note: the Photos media section shows also videos. Enable this only if you wish to access videos separately.' => '注意: 照片媒体部分还显示视频, 仅当您希望单独访问视频时才启用此功能',
                    'Music' => '音乐',
                    'Various features' => '其他特性',
                    'Enable collections' => '启用收藏',
                    'Enable download cart' => '启用下载购物车',
                    ...
                    'Paginate large folders' => '文件夹分页',
                    'files per page' => '个文件页',
                    'Hide dotfiles (~/.*)' => '隐藏点号开头的文件 (~/.*)',
                    'Grid view' => '网格视图',
                    'List view' => '列表视图',
                    'Image gallery' => '图库视图',
                    'Download all' => '下载全部',
                    ...
                    // ====================================================================================
                    // Files --> Thumbnails and preview
                    'Thumbnails and preview' => '缩略图与预览',
                    // Thumbnail settings
                    'Thumbnail settings' => '缩略图设置',
                    'Thumbnail size' => '缩略图大小',
                    'Thumbnail size for "Photos" display mode' => '照片缩略图大小',
                    'Use as thumbnails photos smaller than' => '用作缩略图, 当图片小于',
                    'Megabytes' => 'MB',
                    'Process even the small files, if their resolution is too high' => '处理高分辨率的小文件',
                    'Thumbnails display aspect ratio' => '缩略图显示纵横比',
                    // Preview settings
                    'Preview settings' => '预览设置',
                    'Preview resolution' => '预览分辨率',
                    'Automatic (Default)' => '自动 (默认)',
                    'Full (No processing)' => '完整分辨率 (无处理)',
                    'Large (2480 x 1000)' => '高 (2480 x 1000)',
                    'Medium (1860 x 750)' => '中 (1860 x 750)',
                    'Small (1240 x 500)' => '低 (1240 x 500)',
                    'Use the thumbnail' => '使用缩略图',
                    'Open without processing photos smaller than' => '不处理图片, 当图片小于',
                    // Enable Vips support (v8.10+)
                    'Enable Vips support (v8.10+)' => '启用 vips库 支持 (v8.10+)',
                    'Enables fast thumbnail generation for the most common image file formats.' => '对大部分图片格式, 启用快速缩略图功能.',
                    'Path of "vipsthumbnail" binary' => 'vipsthumbnail 可执行文件路径',
                    'Use with the following file types' => '对以下格式启用',
                    // Enable ImageMagick support
                    'Enable ImageMagick support' => '启用 ImageMagick 支持',
                    'IMagick is a PHP extension which makes use of ImageMagick.' => 'IMagick是一个能最大化利用ImageMagick的PHP扩展',
                    'Enables thumbnail generation for various file formats.' => '对多种文件格式, 启用缩略图生成功能.',
                    'Mode: IMagick PHP Extension' => 'IMagick PHP 扩展模式',
                    'Path to "magick" or "convert" binary' => 'magic 或 convert 可执行文件路径',
                    // Enable FFmpeg support.
                    'Enable FFmpeg support.' => '启用 FFmpeg 支持',
                    'Enables thumbnail generation for video files.' => '对视频文件启用 FFmpeg 支持',
                    'Path to FFmpeg binary' => 'FFmpeg 可执行文件路径',
                    'Generate FFmpeg thumbnails for the following file types' => '为下列文件类型创建FFmpeg缩略图',
                    'Time seek' => '检索时间',
                    // Enable LibreOffice support. (v6.3+)
                    'Enable LibreOffice support. (v6.3+)' => '启用 LibreOffice 支持 (v6.3+)',
                    'Enables thumbnail generation for Office documents.' => '对Office文件, 启用缩略图生成功能',
                    'Path to LibreOffice binary' => 'LibreOffice 可执行文件路径',
                    // Enable stl-thumb support.
                    'Enable stl-thumb support.' => '启用 stl-thumb 支持',
                    'Enables thumbnail generation for STL 3D model files.' => '对STL 3D模型文件, 启用缩略图生成功能',
                    'Path to stl-thumb binary' => 'stl-thumb 可执行文件路径',
                    // Enable pngquant support.
                    ...
                    'When "Broad match" is enabled, use <em>"keyword"</em> for exact match.' => '启用"模糊匹配"后, 使用<em>"keyword"</em>进行精确匹配',
                    'When "Exact match" is enabled, use <em>*keyword*</em> for broad match.' => '启用"精确匹配"后, 使用<em>*keyword*</em>进行模糊匹配',
                    ...
                    // Enable content indexing for text documents
                    'Enable content indexing for text documents' => '启用文件索引',
                    'Requires a scheduled task which periodically runs the command line script "cron/process_search_index_queue.php". Do not enable without setting the task.' => '注意: 需要定期运行命令行脚本“cron / process_search_index_queue.php”的计划任务, 请不要在没有设置任务的情况下启用',
                    'Elasticsearch (v6)' => 'Elasticsearch (v6)',
                    'Host URL' => '主机URL',
                    'Test server' => '测试服务器',
                    'Apache Tika (v1.2)' => 'Apache Tika (v1.2)',
                    'Path to Apache Tika jar file' => 'Apache Tika jar文件路径',
                    'Optional path to config file' => '配置文件(可选)',
                    'Test' => '测试',
                    'If a hostname is set, then Apache Tika will be used in server mode.' => '如果设置了主机名, 则 Apache Tika 将在服务器模式下使用', // TODO: not working
                    ...
                    'Web site address' => '网站地址',
                    'Comment' => '评论',
                    'Applies only to first time visitors. Your language preference has already been saved to your browser. You will not see a change if you select a different option here and logout, unless you specifically change it from the login form.' => '仅适用于首次访客。您的语言偏好设置已保存到您的浏览器中。如果您在此处选择其他选项并注销, 则不会看到更改, 除非您从登录表单中专门更改它。',
            ...
            'Notifications' =>
                array (
                    ...
                    'The file "%1" has been uploaded by a visitor inside the folder "%2" which was shared through a link.' => '文件“%1”已经被访客上传到通过链接共享的文件夹“%2”中',
